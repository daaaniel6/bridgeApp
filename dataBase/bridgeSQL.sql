...
CREATE TABLE IF NOT EXISTS `bridges`.`non_structural_elements` (
  ...
  INDEX `fk_non_structural_elements_railing_posts1_idx` (`railing_posts_railing_posts_id` ASC)  ,
  INDEX `fk_non_structural_elements_handrail_railing1_idx` (`handrail_railing_handrail_railing_id` ASC)  ,
  INDEX `fk_non_structural_elements_barrier1_idx` (`barrier_barrier_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`pile` (
  ...
  `image` LONGBLOB NULL DEFAULT NULL,
  PRIMARY KEY (`pile_id`),
  INDEX `fk_pile_support1_idx` (`support_support_id` ASC)  ,
  INDEX `fk_pile_scour1_idx` (`scour_scour_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`superstructure` (
  ...
  INDEX `fk_superstructure_bearing_slab1_idx` (`bearing_slab_bearing_slab_id` ASC)  ,
  INDEX `fk_superstructure_sewer_system1_idx` (`sewer_system_sewer_system_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`municipality` (
  ...
  INDEX `fk_municipality_departament_idx` (`departament_departament_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`bridge` (
  ...
  INDEX `fk_bridge_general_data1_idx` (`general_data_general_data_id` ASC)  ,
  INDEX `fk_bridge_pile1_idx` (`pile_pile_id` ASC)  ,
  INDEX `fk_bridge_superstructure1_idx` (`superstructure_superstructure_id` ASC)  ,
  INDEX `fk_bridge_non_structural_elements1_idx` (`non_structural_elements_non_structural_elements_id` ASC)  ,
  INDEX `fk_bridge_channel1_idx` (`channel_channel_id` ASC)  ,
  INDEX `fk_bridge_other1_idx` (`other_other_id` ASC)  ,
  INDEX `fk_bridge_municipality1_idx` (`municipality_municipality_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`blueprint` (
  ...
  INDEX `fk_blueprint_bridge1_idx` (`bridge_bridge_id` ASC)  ,
...
-- -----------------------------------------------------
-- Table `bridges`.`inspector`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bridges`.`inspector` (
  `inspector_id` BIGINT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(450) NULL DEFAULT NULL,
  `telephone` VARCHAR(450) NULL DEFAULT NULL,
  `email` VARCHAR(450) NULL DEFAULT NULL,
  `role` VARCHAR(450) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `bridges`.`bridge_inspector`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bridges`.`bridge_inspector` (
  `bridge_inspector_id` BIGINT NOT NULL AUTO_INCREMENT,
  `description` VARCHAR(450) NULL DEFAULT NULL,
  `bridge_bridge_id` BIGINT NULL DEFAULT NULL,
  `inspector_inspector_id` BIGINT NULL DEFAULT NULL,
  PRIMARY KEY (`bridge_inspector_id`),
  INDEX `fk_bridge_inspector_bridge1_idx` (`bridge_bridge_id` ASC)  ,
  INDEX `fk_bridge_inspector_inspector1_idx` (`inspector_inspector_id` ASC)  ,
  CONSTRAINT `fk_bridge_inspector_bridge1`
    FOREIGN KEY (`bridge_bridge_id`)
    REFERENCES `bridges`.`bridge` (`bridge_id`),
  CONSTRAINT `fk_bridge_inspector_inspector1`
    FOREIGN KEY (`inspector_inspector_id`)
    REFERENCES `bridges`.`inspector` (`inspector_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `bridges`.`comment` (
  ...
  `user_id` VARCHAR(450) NULL DEFAULT NULL,
  `bridge_bridge_id` BIGINT NULL DEFAULT NULL,
  `inspector_inspector_id` BIGINT NULL DEFAULT NULL,
  PRIMARY KEY (`comment_id`),
  INDEX `fk_comment_bridge1_idx` (`bridge_bridge_id` ASC)  ,
  INDEX `fk_comment_inspector1_idx` (`inspector_inspector_id` ASC)  ,
  CONSTRAINT `fk_comment_bridge1`
    FOREIGN KEY (`bridge_bridge_id`)
    REFERENCES `bridges`.`bridge` (`bridge_id`),
  CONSTRAINT `fk_comment_inspector1`
    FOREIGN KEY (`inspector_inspector_id`)
    REFERENCES `bridges`.`inspector` (`inspector_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `bridges`.`concrete_row` (
  ...
  INDEX `fk_concrete_row_superstructure1_idx` (`superstructure_superstructure_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`council` (
  ...
  INDEX `fk_council_non_structural_elements1_idx` (`non_structural_elements_non_structural_elements_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`image` (
  ...
  INDEX `fk_image_bridge1_idx` (`bridge_bridge_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`image_other` (
  ...
  INDEX `fk_image_other_other1_idx` (`other_other_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`protection_works` (
  ...
  INDEX `fk_protection_works_non_structural_elements1_idx` (`non_structural_elements_non_structural_elements_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`sensor` (
  ...
  INDEX `fk_sensor_bridge1_idx` (`bridge_bridge_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`reading` (
  ...
  INDEX `fk_reading_sensor1_idx` (`sensor_sensor_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`stapes` (
  ...
  INDEX `fk_stapes_bridge1_idx` (`bridge_bridge_id` ASC)  ,
  INDEX `fk_stapes_support1_idx` (`support_support_id` ASC)  ,
  INDEX `fk_stapes_scour1_idx` (`scour_scour_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`row_width` (
  ...
  INDEX `fk_row_width_stapes1_idx` (`stapes_stapes_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`row_width_pile` (
  ...
  INDEX `fk_row_width_pile_pile1_idx` (`pile_pile_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`slab_access` (
  ...
  INDEX `fk_slab_access_non_structural_elements1_idx` (`non_structural_elements_non_structural_elements_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`steel_row` (
  ...
  INDEX `fk_steel_row_superstructure1_idx` (`superstructure_superstructure_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`stretch` (
  ...
  INDEX `fk_stretch_bridge1_idx` (`bridge_bridge_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `bridges`.`user_rol` (
  ...
  INDEX `FKpfraq7jod5w5xd3sxm3m6y1o` (`rol_id` ASC)  ,
